...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice athletic skills and compete in interschool soccer matches",
        "schedule": "Mondays, Wednesdays, 4:00 PM - 6:00 PM",
        "max_participants": 22,
        "participants": ["nina@mergington.edu", "ben@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim practice and water fitness activities for all skill levels",
